$(document).ready(function(){
	...
	document.getElementById("navbar").innerHTML = '<li><a id="flip_Iot" href=# class="" style="margin-left:15px;">Iot</a></li> <li><a id="flip_Edu" href=# class="" style="margin-left:15px;">Edu</a></li> <li><a id="flip_Social" href=# class="" style="margin-left:15px;">Social</a></li><li><a id="flip_Health" href=# class="" style="margin-left:15px;">Health</a></li>';
	document.getElementById("panel").innerHTML = '<div id="panel_Iot">	</div><div id="panel_Edu">	</div><div id="panel_Social">	</div><div id="panel_Health"></div>';	
	...
	var Social = ['police','village'];
	var social = ['social/police.html','social/village.html'];
	var Health = ['hospital'];
	var health = ['health/hospital.html'];
	var IOT="",EDU="",SOCIAL="",HEALTH="";
